...
using Assets.Metater.MetaVoiceChat.Input.Mic;
...
namespace Assets.Metater.MetaVoiceChat
{
    public class MetaVc : MonoBehaviour
    {
        ...
        [Header("General")]
        public int TargetMic;
        public VcAudioInput audioInput;
        public VcAudioOutput audioOutput;
        public VcConfig config;

        [Header("Testing")]
        [Tooltip("This logs all the microphone input devices.")]
        public bool LogInputDevices = false;
        ...
        private void Awake()
        {
            if (MirrorVRManager.instance.enableDefaultVoiceChat)
            {
                config.Init();
